...
const ExperienceItem = (exp: experienceItem) => {
    return (
        <div className='grid lg:grid-cols-8 gap-4 transition-all duration-500 cursor-pointer lg:hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] lg:hover:bg-slate-800/20 hover:backdrop-blur-3xl rounded-lg lg:px-4 lg:py-6 drop-shadow-lg'>
